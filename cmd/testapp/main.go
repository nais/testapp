...
func init() {
	...
	flag.IntVar(&retryMax, "retry-max", 369, "how long in seconds to retry connecting to database")
	flag.IntVar(&retryInterval, "retry-interval", 10, "how many retries before sending interrupt signal to server")
	flag.Parse()
}
